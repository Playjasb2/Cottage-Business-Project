...
<body>
	...
	<div class="container">
		...
		<ol class="breadcrumb">
			<li><a href="index.php">Home</a></li>
			<li class="active">Activate Your Email</li>
		</ol>
		...
		<div class="row">
			...
			<article class="col-sm-8 maincontent">
				<header class="page-header">
					<h1 class="page-title">Activate Your Email</h1>
				</header>
				<?
					if(!$code)
					{
						?>
						<h3>Current Status: No Code Supplied</h3>
						<p>You apparently went to this page without supplying any activation code. Please follow the instructions below on how to activate your account.</p>
						<?
					}
					else
					{
						$db = new DB();
						$check = $db->query("SELECT * FROM users WHERE code='$code' AND active='1'");
						if($check->results())
						{
							?>
							<h3>Current Status: Account Already Activated</h3>
							<p>You have already activated your account.</p>
							<?
						}
						else
						{
							$activate = $db->query("UPDATE users SET active='1' WHERE code='$code'");
							?>
							<h3>Current Status: Account Activated</h3>
							<p>Congratulations! You just activated your account! Please continue using our site!</p>
							<?
						}
					}
				?>
