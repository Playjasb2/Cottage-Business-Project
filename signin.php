		...
		<div class="row">
			...
			<article class="col-xs-12 maincontent">
				<header class="page-header">
					<h1 align = "center" class="page-title">Sign in</h1>
				</header>
				...
				<div class="col-md-6 col-md-offset-3 col-sm-8 col-sm-offset-2">
					<div class="panel panel-default">
						<div class="panel-body">
							...
							<p class="text-center text-muted">To register please click this link, <a href="signup.php">Register</a> To log in, please fill out the form correctly with your username and password. </p>
							<hr>
